            ...
            <div className="container mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="space-y-6">
                        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-md hover:shadow-lg hover:border-neon-cyan/50 transition-all">
                        ...
                        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-md hover:shadow-lg hover:border-neon-cyan/50 transition-all">
                            ...
                            <p className="text-gray-600">info@digimax.com</p>
                            <p className="text-gray-600">support@digimax.com</p>
                        </div>
                    ...
                    <div className="lg:col-span-2">
                        <div className="p-8 bg-white border border-gray-100 rounded-2xl shadow-xl">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-neon-cyan focus:outline-none transition-colors"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        onChange={handleChange}
                                        rows={6}
                                        className="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-400 focus:border-neon-cyan focus:outline-none transition-colors resize-none"
                                ...
                                <button
                                    type="submit"
                                    className="w-full md:w-auto px-8 py-4 bg-neon-cyan text-black font-bold rounded-full hover:bg-neon-cyan/80 hover:shadow-[0_0_20px_rgba(0,243,255,0.6)] transition-all duration-300 flex items-center justify-center gap-2"
                                >
